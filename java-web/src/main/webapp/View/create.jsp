        ...
        <div class="field-input">
            ...
            <form method="POST" role="form">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                        <input type="text" class="form-control" name="country" placeholder="Nhập tên quốc gia">
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <textarea class="form-control" name="instruction" placeholder="Thêm giới thiệu về thành phố của bạn" id="floatingTextarea2" style="height: 100px"></textarea>
                    </div>
                </div>
                <div class="row">
                    <center>
